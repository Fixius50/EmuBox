...

{
  ...
  echo "Acceleration: $HAS_ACCELERATION; backend: $GRAPHICS_BACKEND; gpuKind: $GPU_KIND; VM: $IS_VIRTUAL_MACHINE; gamescopeReady: $GAMESCOPE_READY"
  echo "Detection: $GRAPHICS_DETECTION_STATE; reasons: $GRAPHICS_PROBE_REASONS; operationalBackend: $GRAPHICS_OPERATIONAL_BACKEND; fallback: $GRAPHICS_FALLBACK_REASON"
  echo "Selected device: $GPU_DEVICE; active device: $GPU_ACTIVE_DEVICE"
