...
const forcedCpuCaps = graphicsDetector.detectFromHardware({ ...await backend.getHardwareInfo(), gpuRenderer: 'llvmpipe', graphicsAccelerated: false });
...
const forcedGpuCaps = graphicsDetector.detectFromHardware(await backend.getHardwareInfo());
