        ...
        <div class="console-modal-center-container">
          <Dialog.Content class="crud-modal-box xmb-maintenance">
            <div style={{ display: "flex", "align-items": "center", "justify-content": "space-between", "border-bottom": "0.0625rem solid rgba(255, 255, 255, 0.1)", "padding-bottom": "0.75rem" }}>
              ...
              <Dialog.CloseButton class="xmb-icon-button" title="Cerrar mantenimiento" aria-label="Cerrar mantenimiento"><X size={20} /></Dialog.CloseButton>
            </div>
                  ...
                  return (
                    <SettingCardRow
                      ...
                      style={{
                        ...
                        "border-color": isFocused() ? "var(--xmb-accent)" : "var(--xmb-border)",
